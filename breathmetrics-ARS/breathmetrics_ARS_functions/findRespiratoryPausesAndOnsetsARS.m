function [ inhaleOnsets, exhaleOnsets, inhalePauseOnsets, ...
    exhalePauseOnsets ] = ...
    findRespiratoryPausesAndOnsetsARS( resp, myPeaks, myTroughs, nBINS )
...
for THIS_BREATH = 1:length(myPeaks)-1
    ...
    if myTroughs(THIS_BREATH) == 1
        ...
        INHALE_WINDOW = resp(myPeaks(THIS_BREATH):myPeaks(THIS_BREATH+1));
        ...
        inhaleOnsets(1, THIS_BREATH + 1) = myPeaks( THIS_BREATH ) + INHALE_ONSET;
